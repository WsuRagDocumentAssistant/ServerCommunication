"""
rest_channel.py
외부 LLM API(Claude/GPT/Gemini) REST 채널
- 프로바이더 조회/생성 로직(예전 llm_api_service.py)을 여기로 흡수함
- 실제 프로바이더 구현체는 services/llm_api/ 에 있음
"""

from typing import AsyncGenerator, Optional, Union

from interfaces import BaseChannelInterface, BaseLLMApiInterface
